...
namespace AD
{
    ...
    public partial class GraphTests
    {
        ...
        public void Graph_01_Vertex_01_Reset()
        {
            ...
            // Assert
            Assert.That(v.GetDistance(), Is.EqualTo(Graph.INFINITY));
            Assert.That(v.GetPrevious(), Is.Null);
            Assert.That(v.GetKnown(), Is.False);
        }
        ...
        public void Graph_02_AddVertex_01_OnEmptyGraph()
        {
            ...
            // Assert
            Assert.That(graph.vertexMap.Count, Is.EqualTo(expected_count));
            Assert.That(graph.vertexMap.Last().Key, Is.EqualTo(expected_name));
        }
        ...
        public void Graph_03_GetVertex_01_OnEmptyGraph()
        {
            ...
            Assert.That(graph.vertexMap.Count, Is.EqualTo(expected_count));
            Assert.That(graph.vertexMap.Last().Key, Is.EqualTo(expected_name));
            Assert.That(v.GetName(), Is.EqualTo(expected_name));
            Assert.That(v.GetDistance(), Is.EqualTo(Graph.INFINITY));
            Assert.That(v.GetPrevious(), Is.Null);
            Assert.That(v.GetKnown(), Is.False);
        }
        ...
        public void Graph_04_AddEdge_01_OnEmptyGraph()
        {
            ...
            // Assert
            Assert.That(graph.vertexMap.Count, Is.EqualTo(2));
            Assert.That(vertex.GetAdjacents().Count, Is.EqualTo(1));
            Assert.That(vertex.GetAdjacents().First.Value.cost, Is.EqualTo(3));
            Assert.That(vertex.GetAdjacents().First.Value.dest.name, Is.EqualTo("2"));
        }
        ...
        [Test]
        public void Graph_07_Dijkstra_03_OnWeightedGraphFromLectureExercise()
        {
            // Arrange
