...
namespace AD
{
    ...
    public partial class MyLinkedListTests
    {
        ...
        [Test]
        public void MyLinkedList_4_Clear_3_FirstEqualsNullOnList1()
        {
            // Ugly unittest. Normally we test only functionallity (so
            // we use the interfaces. Now we really want to see the
            // contents, so we use MyLinkedList instead of IMyLinkedList
            ...
            // Assert
            Assert.That(lst.first, Is.Null);
        }

        [Test]
        public void MyLinkedList_4_Clear_4_SizeEquals0OnList3()
        {
            // Arrange
            IMyLinkedList<string> lst = DSBuilder.CreateMyLinkedListStringEmpty();
            lst.AddFirst("1");
        ...
        [Test]
        public void MyLinkedList_4_Clear_5_FirstEqualsNullOnList3()
        {
            // Ugly unittest. Normally we test only functionallity (so
            // we use the interfaces. Now we really want to see the
            // contents, so we use MyLinkedList instead of IMyLinkedList
